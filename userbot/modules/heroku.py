...
@bot.on(zelda_cmd(outgoing=True, pattern=r"(get|del) var(?: |$)(\w*)"))
...
@bot.on(zelda_cmd(outgoing=True, pattern=r"set var (\w*) ([\s\S]*)"))
...
@bot.on(zelda_cmd(outgoing=True, pattern=r"(usage|kuota)(?: |$)"))
...
@bot.on(zelda_cmd(outgoing=True, pattern=r"logs"))
async def _(dyno):
    if app is None:
...
@bot.on(zelda_cmd(outgoing=True, pattern=r"getdb ?(.*)"))
...
@bot.on(zelda_cmd(outgoing=True, pattern=r"setdb ?(.*)"))
...
@bot.on(zelda_cmd(outgoing=True, pattern=r"deldb ?(.*)"))
