...
async def amireallyalive(alive):
    ...
    output = (
        f"**[ZELDA USERBOT](https://github.com/nmiabdfhmy/Zelda-Ubot)** by **[LORD ZELDA](https://t.me/UnrealZlda)**\n\n"
