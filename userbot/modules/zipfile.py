...
@bot.on(zelda_cmd(outgoing=True, pattern=r"compress(?: |$)(.*)"))
async def _(event):
...
@bot.on(zelda_cmd(outgoing=True, pattern=r"addzip(?: |$)(.*)"))
...
@bot.on(zelda_cmd(outgoing=True, pattern=r"upzip(?: |$)(.*)"))
...
@bot.on(zelda_cmd(outgoing=True, pattern=r"rmzip(?: |$)(.*)"))
