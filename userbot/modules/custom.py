...
from userbot.utils import edit_delete, edit_or_reply, zelda_cmd, reply_id


@zelda_cmd(pattern=r"\#(\S+)")
...
@zelda_cmd(pattern="custom(?:\\s|$)([\\s\\S]*)")
...
@zelda_cmd(pattern="delcustom(?:\\s|$)([\\s\\S]*)")
async def _(event):
