...
@bot.on(zelda_cmd(outgoing=True, pattern=r"(d)?fban(?: |$)(.*)"))
...
@bot.on(zelda_cmd(outgoing=True, pattern=r"unfban(?: |$)(.*)"))
...
@bot.on(zelda_cmd(outgoing=True, pattern=r"addf(?: |$)(.*)"))
...
@bot.on(zelda_cmd(outgoing=True, pattern=r"delf$"))
...
@bot.on(zelda_cmd(outgoing=True, pattern=r"listf$"))
...
@bot.on(zelda_cmd(outgoing=True, pattern=r"clearf$"))
