...
@bot.on(zelda_cmd(outgoing=True, pattern=r"nmap(?: |$)(.*)"))
async def _(event):
    if event.fwd_from:
        return
...
@bot.on(zelda_cmd(outgoing=True, pattern=r"subd(?: |$)(.*)"))
async def _(event):
    if event.fwd_from:
        return
    link = event.pattern_match.group(1)
...
@bot.on(zelda_cmd(outgoing=True, pattern=r"cek(?: |$)(.*)"))
async def _(event):
    if event.fwd_from:
        return
    link = event.pattern_match.group(1)
...
@bot.on(zelda_cmd(outgoing=True, pattern=r"bin(?: |$)(.*)"))
async def _(event):
    if event.fwd_from:
        return
    link = event.pattern_match.group(1)
...
@bot.on(zelda_cmd(outgoing=True, pattern=r"cc(?: |$)(.*)"))
async def _(event):
    if event.fwd_from:
        return
    link = event.pattern_match.group(1)
