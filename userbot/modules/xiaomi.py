...
@bot.on(zelda_cmd(outgoing=True, pattern=r"firmware(?: |$)(.*)"))
async def _(event):
    if event.fwd_from:
        return
...
@bot.on(zelda_cmd(outgoing=True, pattern=r"fastboot(?: |$)(.*)"))
async def _(event):
    if event.fwd_from:
        return
    link = event.pattern_match.group(1)
...
@bot.on(zelda_cmd(outgoing=True, pattern=r"recovery(?: |$)(.*)"))
async def _(event):
    if event.fwd_from:
        return
    link = event.pattern_match.group(1)
...
@bot.on(zelda_cmd(outgoing=True, pattern=r"pb(?: |$)(.*)"))
async def _(event):
    if event.fwd_from:
        return
    link = event.pattern_match.group(1)
...
@bot.on(zelda_cmd(outgoing=True, pattern=r"of(?: |$)(.*)"))
async def _(event):
    if event.fwd_from:
        return
    link = event.pattern_match.group(1)
...
@bot.on(zelda_cmd(outgoing=True, pattern=r"eu(?: |$)(.*)"))
async def _(event):
    if event.fwd_from:
        return
    link = event.pattern_match.group(1)
...
@bot.on(zelda_cmd(outgoing=True, pattern=r"vendor(?: |$)(.*)"))
async def _(event):
    if event.fwd_from:
        return
    link = event.pattern_match.group(1)
...
@bot.on(zelda_cmd(outgoing=True, pattern=r"specs(?: |$)(.*)"))
async def _(event):
    if event.fwd_from:
        return
    link = event.pattern_match.group(1)
