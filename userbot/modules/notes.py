...
@bot.on(zelda_cmd(outgoing=True, pattern=r"notes$"))
...
@bot.on(zelda_cmd(outgoing=True, pattern=r"clear (\w*)"))
...
@bot.on(zelda_cmd(outgoing=True, pattern=r"save (\w*)"))
...
@bot.on(zelda_cmd(outgoing=True, pattern=r"rmbotnotes (.*)"))
