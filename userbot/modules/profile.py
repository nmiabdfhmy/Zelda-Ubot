...
@bot.on(zelda_cmd(outgoing=True, pattern=r"reserved$"))
...
@bot.on(zelda_cmd(outgoing=True, pattern=r"name"))
...
@bot.on(zelda_cmd(outgoing=True, pattern=r"setpfp$"))
...
@bot.on(zelda_cmd(outgoing=True, pattern=r"setbio (.*)"))
...
@bot.on(zelda_cmd(outgoing=True, pattern=r"username (.*)"))
...
@bot.on(zelda_cmd(outgoing=True, pattern=r"count$"))
...
@bot.on(zelda_cmd(outgoing=True, pattern=r"delpfp"))
...
@bot.on(zelda_cmd(pattern=r"info(?: |$)(.*)", outgoing=True))
async def who(event):
