...
@bot.on(zelda_cmd(outgoing=True, pattern=r"link(?: |$)(.*)"))
...
@bot.on(zelda_cmd(outgoing=True, pattern=r"bots(?: |$)(.*)"))
async def _(event):
    if event.fwd_from:
        return
...
@bot.on(zelda_cmd(outgoing=True, pattern="kickme$"))
...
@bot.on(zelda_cmd(outgoing=True, pattern="kikme$"))
...
@bot.on(zelda_cmd(outgoing=True, pattern="unmutechat$"))
...
@bot.on(zelda_cmd(outgoing=True, pattern="mutechat$"))
...
@bot.on(zelda_cmd(incoming=True))
...
@bot.on(zelda_cmd(outgoing=True, pattern="s/"))
...
@bot.on(zelda_cmd(outgoing=True, pattern=r"regexninja (on|off)$"))
...
@bot.on(zelda_cmd(outgoing=True, pattern=r"chatinfo(?: |$)(.*)"))
...
@bot.on(zelda_cmd(outgoing=True, pattern=r"invite(?: |$)(.*)"))
async def _(event):
    if event.fwd_from:
        return
...
@bot.on(zelda_cmd(outgoing=True, pattern=r"inviteall ?(.*)"))
...
@bot.on(zelda_cmd(outgoing=True, pattern="getmember$"))
...
@bot.on(zelda_cmd(outgoing=True, pattern="addmember$"))
