...
@bot.on(zelda_cmd(outgoing=True, pattern=r"anilist ?(.*)"))
...
@bot.on(zelda_cmd(outgoing=True, pattern=r"anime ?(.*)"))
...
@bot.on(zelda_cmd(outgoing=True, pattern=r"manga ?(.*)"))
...
@bot.on(zelda_cmd(outgoing=True, pattern="a(kaizoku|kayo) ?(.*)"))
...
@bot.on(zelda_cmd(outgoing=True, pattern=r"char ?(.*)"))
...
@bot.on(zelda_cmd(outgoing=True, pattern="upcoming$"))
...
@bot.on(zelda_cmd(outgoing=True, pattern="whatanime$"))
