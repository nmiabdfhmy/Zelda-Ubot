...
@bot.on(zelda_cmd(outgoing=True, pattern=r"filter (.*)"))
...
@bot.on(zelda_cmd(outgoing=True, pattern=r"stop (.*)"))
...
@bot.on(zelda_cmd(outgoing=True, pattern=r"delfilterbot (.*)"))
...
@bot.on(zelda_cmd(outgoing=True, pattern=r"filters$"))
